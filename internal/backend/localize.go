...
var translations = map[string]map[string]string{
	localeEnglish: {
		...
		"error.auth_import_not_json":               "Selected file is not a JSON auth file: %s",
		"error.auth_import_invalid_json":           "Selected file does not contain valid JSON: %s",
		"error.auth_import_invalid_name":           "Invalid auth file name: %s",
		"error.auth_import_empty_directory":        "Selected directory does not contain any JSON auth files.",
		"error.auth_import_directory_invalid":      "Selected path is not a directory.",
		"error.auth_import_source_required":        "An auth import source directory is required for automatic import.",
		"error.auth_import_auto_cron_required":     "An auth import cron expression is required for automatic import.",
		"error.auth_import_archive_same_directory": "The auth import archive directory cannot be the same as the source directory.",
		...
		"task.schedule.queued_active":              "Scheduled %s queued because %s is already running",
		...
		"task.import.prepared":                     "Prepared %d auth files for import",
		"task.import.no_files":                     "No auth files found in the import directory.",
		"task.import.summary":                      "Imported %d/%d auth files (failed=%d, skipped=%d).",
		"task.import.sync_failed":                  "Inventory sync failed: %v.",
		"task.import.archived":                     "Archived %d file(s) to %s.",
		"task.import.archive_failed":               "%d file(s) could not be moved to the archive directory.",
	...
	localeChinese: {
		...
		"error.auth_import_not_json":               "所选文件不是 JSON auth 文件：%s",
		"error.auth_import_invalid_json":           "所选文件的 JSON 格式无效：%s",
		"error.auth_import_invalid_name":           "auth 文件名无效：%s",
		"error.auth_import_empty_directory":        "所选目录中没有 JSON auth 文件。",
		"error.auth_import_directory_invalid":      "所选路径不是目录。",
		"error.auth_import_source_required":        "启用自动导入前必须填写认证导入目录。",
		"error.auth_import_auto_cron_required":     "启用自动导入前必须填写 Cron 表达式。",
		"error.auth_import_archive_same_directory": "认证归档目录不能和导入目录相同。",
		...
		"task.schedule.queued_active":              "定时%s已排队，等待%s结束后补跑",
		"task.schedule.skipped_active":             "定时%s已跳过，因为%s正在执行",
		"task.schedule.completed":                  "定时%s已完成",
		"task.schedule.failed":                     "定时%s执行失败：%v",
		"task.import.prepared":                     "已准备 %d 个待导入 auth 文件",
		"task.import.no_files":                     "导入目录里没有可导入的 auth 文件。",
		"task.import.summary":                      "已导入 %d/%d 个 auth 文件（失败=%d，跳过=%d）。",
		"task.import.sync_failed":                  "inventory 同步失败：%v。",
		"task.import.archived":                     "已将 %d 个文件归档到 %s。",
		"task.import.archive_failed":               "有 %d 个文件归档失败。",
...
func taskName(locale string, taskKind string) string {
	...
	case "import":
		return msg(locale, "task.name.import")
	case "inventory":
